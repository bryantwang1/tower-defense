...
TowerDefense.FreezeTower = function (parentState, posX, posY) {
      ...
      TowerDefense.Tower.call(parentState, posX, posY, 'freeze-tower', 150, 800, 0, 300, 'freeze');

}

TowerDefense.FreezeTower.prototype = Object.create(TowerDefense.Enemy.prototype);
